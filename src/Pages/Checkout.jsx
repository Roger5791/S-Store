    ...
    <div className="checkout-container">
      <div className="checkout-group">
        ...
        <form action="" className="form grid">
          ...
          <input type="text" className="form-input" placeholder="Postal Code /  ZIP" />
          <input type="text" className="form-input" placeholder="Phone" />
          <input type="text" className="form-input" placeholder="Email" />

          <h3 className="checkout-title">Additional Information</h3>

          <textarea name="" placeholder="Order remarks, Instructions..." className="form-input textarea" id="" cols="30" rows="10"></textarea>
        </form>
      </div>
        ...
        <table className="order-table"  >
...

          {
            cartItem.map((item, id) => {
                return (
          <tr key={id}>
            <td><img src={item.image} alt="" className="order-img" /></td>
          ...
          <td><span className="table-title">${item.price * item.quantity}</span></td>
...
<tr >
        ...
        <td className='order-grandtotal' colSpan={2}>Grand Total</td>
        ...
        <button type="button" className="checkout-btn" id="orderBtn" onClick={handleOrder}>Place Order</button>
